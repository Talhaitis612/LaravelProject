...
<div class="container">
    ...
    <div class="jumbotron">
        <h2>Introduction</h2>
        <p class="lead">Video provides a powerful way to help you prove your point. When you click Online Video, you can
        ...
        <p class="lead">Save time in Word with new buttons that show up where you need them. To change the way a picture
